  ...
  return (
    <div className="relative flex flex-col min-h-[calc(100svh-60px)] bg-background overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden flex justify-center">
        <div className="absolute top-[-20%] w-200 h-100 bg-amber-500/10 dark:bg-amber-500/5 blur-[120px] rounded-[100%] opacity-70 transition-opacity duration-700" />
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12 relative z-10">
        <div className="w-full max-w-xl mx-auto flex flex-col items-center">
          ...
          <div className="w-full rounded-3xl border border-border/50 bg-background/60 backdrop-blur-2xl shadow-xl dark:shadow-2xl dark:shadow-black/40 overflow-hidden relative">
            {/* Top decorative bar */}
            <div className="h-1.5 w-full bg-linear-to-r from-amber-400 via-orange-400 to-amber-500 opacity-90"></div>

            <div className="p-10 sm:p-14 flex flex-col items-center gap-8">
              {/* Heading */}
              <div className="flex flex-col items-center gap-3 text-center">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-amber-100 to-orange-50 dark:from-amber-900/40 dark:to-orange-900/20 border border-amber-200/50 dark:border-amber-500/20 flex items-center justify-center mb-2 shadow-sm">
                ...
                <p className="text-muted-foreground text-sm sm:text-base max-w-sm leading-relaxed">
                  Drop your PDF securely to begin interacting with the AI
                  instantly.
                </p>
              </div>
              ...
              >
                ...
                >
                  <FileUp className="h-7 w-7 transition-colors" />
                </div>
